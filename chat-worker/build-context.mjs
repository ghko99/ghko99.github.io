...
const lines = [
  "이름 고강희(Ganghee Go). 인하대학교 전기컴퓨터공학과 인공지능 전공 석사(2024.09–2026.08, 학점 4.38/4.5), 금융인공지능(AIF) 연구실, 지도교수 김도국. 학부 인하대 컴퓨터공학 우수 졸업(2018.03–2024.02, 평점 4.15/4.5, 전공 4.23, 졸업 석차 13/138). 연수고등학교(2015–2018).",
  "연락: 이메일 khko99@naver.com, GitHub github.com/ghko99, 블로그 velog.io/@khko99, ORCID 0009-0006-1027-105X. 전화번호는 공개하지 않음.",
