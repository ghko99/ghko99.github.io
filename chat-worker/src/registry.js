...
export const REGISTRY = [
 ...
 },
 {
  ...
  "url": "https://ghko99.github.io/#cv",
  "summary": "과기정통부·IITP의 생성AI 선도인재양성 사업. 포티투마루가 주관하고 인하대·성균관대·부산대·UNIST가 참여하며, 인하대는 생성 AI 기반 물류 혁신 솔루션을 주제로 함. 본인은 2025.07–10 참여 연구원으로 참여했으며, 본인이 담당한 세부 업무·산출물은 기록돼 있지 않음 (사업 전체의 개발 내용은 본인 성과가 아님).",
  "repos": []
 }
];
