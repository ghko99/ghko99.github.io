...
export const STACK: Record<string, Stack> = {
  ...
  'proj-geulgyeol': [['Kanana-1.5-8B-Instruct', 'kakao.svg'], ['vLLM', 'vllm.png'], ['FastAPI', 'fastapi.svg'], ['Transformers · PEFT (LoRA)', HF], ['PyTorch', 'pytorch.svg'], ['Sentence-Transformers · KeyBERT', HF], ['Bareun · Kiwi 형태소 분석']],
